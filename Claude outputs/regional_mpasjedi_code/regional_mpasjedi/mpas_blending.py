...
# ============================================================
# Optional diagnostics: filtered-field output
# ============================================================
class OutputManager:
...
def run(cfg: Config) -> None:
    ...
    need_full_filtered = cfg.output_filtered_fields
    ...
    output_mgr = OutputManager(cfg) if cfg.output_filtered_fields else None
